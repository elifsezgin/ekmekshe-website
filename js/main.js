...
(function($) {
  ...
  var OnePageNav = function() {
    ...
    $(".smoothscroll[href^='#'], #ftco-navbar ul li a[href^='#']").on(
      "click",
      function(e) {
        e.preventDefault();
        var hash = this.hash;
  ...
  if (document.getElementById("map")) {
    ...
    function init() {
      var mapOptions = {
        zoom: 11,
        center: new google.maps.LatLng(36.200949, 29.647471), // Kaş, Antalya
        styles: [
          {
            featureType: "water",
      ...
      var marker = new google.maps.Marker({
        position: new google.maps.LatLng(36.200949, 29.647471),
        map: map,
        title: "Snazzy!"
      });
    }
